...
output_dir = f"hdfs://hdfs-namenode:9000/user/{username}/Q4_SQL_PARQ{job_id}"
...
taxis_df = spark.read.parquet(f"hdfs://hdfs-namenode:9000/user/{username}/yellow_tripdata_2024.parquet")
